(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerpolicy&&(o.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?o.credentials="include":e.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=t(e);fetch(e.href,o)}})();const i=document.querySelector("#suggested-channels-content"),c=async()=>{const s=["https://youtube-v31.p.rapidapi.com/channels?part=snippet%2Cstatistics&id=UC8LeXCWOalN8SxlrPcG-PaQ","https://youtube-v31.p.rapidapi.com/channels?part=snippet%2Cstatistics&id=UCHRp19HU7Y2LwfI0Ai6WAGQ","https://youtube-v31.p.rapidapi.com/channels?part=snippet%2Cstatistics&id=UCJZv4d5rbIKd4QHMPkcABCw","https://youtube-v31.p.rapidapi.com/channels?part=snippet%2Cstatistics&id=UCw05fUBPwmpu-ehXFMqfdMw"],n={method:"GET",headers:{"X-RapidAPI-Key":"752040bbc6msh8a523dcc0d4f1c6p170442jsn27e907cefd3a","X-RapidAPI-Host":"youtube-v31.p.rapidapi.com"}};try{return await Promise.all(s.map(a=>fetch(a,n).then(e=>e.json())))}catch(t){console.log("Error",t)}};(async()=>{try{const s=await c();let n="";s.map(t=>{t.items.map(a=>{n+=`<section class="gap-4 items-center shadow-lg w-full xl:gap-4 md:grid md:grid-cols-2 rounded-lg">
            ...
            <div class="mt-4 md:mt-0 p-4 pt-0">
                ...
                <a 
                  href="https://www.youtube.com/channel/${a?.id}" 
